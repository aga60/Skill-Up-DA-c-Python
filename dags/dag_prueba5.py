...
# y una función
# y la definición de tres tareas, operadores, se agrega los import correspondientes
# y corre, y realiza bien la tarea python pero falla en la Bash, dummy no hace nada
